...
\begin{table*}[hbt]
\caption{Automatic evaluation metrics. Generation scores are marked n/a for retrieval-only runs because no answer was generated.}
\centering
\small
...
\midrule
V1 old dense run & 20 & 0.40 & 0.00 & 0.00 & 0.00 & n/a & n/a \\
V2 fixed dense & 20 & 0.40 & 0.00 & 0.00 & 0.40 & n/a & n/a \\
V2 legal hybrid retrieval & 20 & 0.95 & 0.30 & 0.35 & 1.30 & n/a & n/a \\
V2 legal hybrid + baseline prompt & 20 & 0.95 & 0.30 & 0.35 & 1.30 & 1.45 & 0.65 \\
V2 legal hybrid + strict prompt & 20 & 0.95 & 0.30 & 0.35 & 1.30 & 1.05 & 0.80 \\
\bottomrule
\end{tabular}
\label{tab:retrieval}
\end{table*}
